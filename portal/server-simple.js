...
app.listen(PORT, async () => {
    ...
    console.log(`\n🎉 Portal (simple) is ready!`);
    console.log(`📧 Access at: http://localhost:${PORT}`);
    console.log(`🌐 Or: http://${process.env.SERVER_IP || 'your-server-ip'}:${PORT}`);
    console.log(`🔐 Test admins (use either username or email):`);
    console.log(`   • hligon / temporary  (hligon@getsparqd.com)`);
    console.log(`   • bhall  / temporary  (bhall@getsparqd.com)`);
});
